...
import de.invesdwin.context.haskell.runtime.etlas.EtlasProperties;
 ...
 */
@NotThreadSafe
public class ModifiedEtlasBridge {
    ...
    private ModifiedEtlasErrorConsoleWatcher errWatcher = null;
    ...
    public ModifiedEtlasErrorConsoleWatcher getErrWatcher() {
        return errWatcher;
    }
    ...
    public void open() throws IOException {
        ...
        errWatcher = new ModifiedEtlasErrorConsoleWatcher(julia);
